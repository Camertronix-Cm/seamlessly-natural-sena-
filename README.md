...
<ol>
  <li>Unzip the <code>UDIS_datasetuni</code> folder included in the repository.</li>
  <li>It contains all the necessary data for evaluation.</li>
  <li>Run the evaluation script to compute the <code>PSNR</code> and <code>SSIM</code> scores.</li>
</ol>
You can download the test dataset and some of the results we obtained on different datasets here:  
